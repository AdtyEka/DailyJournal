                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                if ($row["gambar"] != '') {
                                    if (file_exists('assets/images/article/' . $row["gambar"] . '')) {
                                ?>
                                        <img src="assets/images/article/<?= $row["gambar"] ?>" width="100">
                                <?php
                                    }
                                }
                                ?>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        if ($row["gambar"] != '') {
                                                            if (file_exists('assets/images/article/' . $row["gambar"] . '')) {
                                                        ?>
                                                                <br><img src="assets/images/article/<?= $row["gambar"] ?>" width="100">
                                                        <?php
                                                            }
                                                        }
                                                        ?>
